    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "email1@email.fr", "$2a$11$//ZloPEPVhsYIUdYZKfZd.agrkZlzz/hMJKn6uB.Zcq4o66Ooor82", "User", "sexe1", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "prenom1" },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "email2@email.fr", "$2a$11$HD2nxGgHTtEtvXYgOI9dxekNjEWiyxo4AjSAnqYsgSX5PBZtBN7wq", "Admin", "sexe1", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "prenom2" }
                });
